...
router.get('/place-order', authController.authenticateUser, categoryController.getListedCategories, cartController.getCartItemsCount, serviceRender.getOrderPlacedPage);
